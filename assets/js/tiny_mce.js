(function (e) {
    ...
    var c = {majorVersion: "3", minorVersion: "5.11", releaseDate: "2014-05-08", _init: function () {
...
tinymce.util.Quirks = function (a) {
    ...
    function x() {
        ...
        C("enableObjectResizing", false);
        ac = {n: [0.5, 0, 0, -1], e: [1, 0.5, 1, 0], s: [0.5, 1, 0, 1], w: [0, 0.5, -1, 0], nw: [0, 0, -1, -1], ne: [1, 0, 1, -1], se: [1, 1, 1, 1], sw: [0, 1, -1, 1]};
        function T(aj) {
            var ai, ah;
            ai = aj.screenX - ad;
            ah = aj.screenY - ab;
        ...
        function S(ak) {
            ...
            G(ac, function (an, al) {
                ...
                if (!am) {
                    am = e.add(V.documentElement, "div", {id: "mceResizeHandle" + al, "class": "mceResizeHandle", style: "cursor:" + al + "-resize; margin:0; padding:0"});
                ...
                e.setStyles(am, {left: (aj * an[0] + P) - (am.offsetWidth / 2), top: (ah * an[1] + O) - (am.offsetHeight / 2)})
            });
